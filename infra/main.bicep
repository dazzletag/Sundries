    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        }
        {
          ...
          value: format('@Microsoft.KeyVault(SecretUri={0})', reference(resourceId('Microsoft.KeyVault/vaults/secrets', keyVault.name, 'CAREHQ-ACCOUNT-ID'), '2024-11-01').secretUriWithVersion)
        }
        {
          name: 'CAREHQ_API_KEY'
          value: format('@Microsoft.KeyVault(SecretUri={0})', reference(resourceId('Microsoft.KeyVault/vaults/secrets', keyVault.name, 'CAREHQ-API-KEY'), '2024-11-01').secretUriWithVersion)
        }
        {
          name: 'CAREHQ_API_SECRET'
          value: format('@Microsoft.KeyVault(SecretUri={0})', reference(resourceId('Microsoft.KeyVault/vaults/secrets', keyVault.name, 'CAREHQ-API-SECRET'), '2024-11-01').secretUriWithVersion)
        }
        {
          name: 'TENANT_ID'
          value: aadTenantId
