...
var databaseConnectionString = format('sqlserver://{0}:{1}@{2}.{3}:1433/{4}?encrypt=True&trustServerCertificate=False', sqlAdminLogin, sqlAdminPassword, sqlServerName, sqlServerHostnameSuffix, databaseName)
